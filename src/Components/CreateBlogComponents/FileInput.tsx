    ...
    <div className="">
      {showName ? (
        <div className="mx-auto flex max-w-[600px] items-center gap-x-6 rounded-lg border-2 border-dashed border-gray-400 p-5 bg-white">
          ...
          <div onClick={handleClearFile} className="cursor-pointer">
            <svg
              width={30}
              viewBox="0 -0.5 25 25"
              fill="none"
        ...
        <label
          className="mx-auto flex max-w-[600px] flex-col items-center justify-center space-y-3 rounded-lg border-2 border-dashed border-gray-400 p-6 bg-white cursor-pointer"
          htmlFor="file5"
        >
          <svg
            width={50}
