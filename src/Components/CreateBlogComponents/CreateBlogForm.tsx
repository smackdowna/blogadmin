...
const CreateBlogForm = () => {
  ...
  const { register, handleSubmit, formState: { errors }, setValue, watch } = useForm<CreateBlogFormInputs>();
...
<div className="space-y-2 text-sm">
  <label htmlFor="category" className="block text-zinc-700 font-medium">
  ...
  <div className="flex gap-4">
    ...
    >
      ...
      {allCategories
        ?.find((cat: any) => cat._id === watch("category"))?.subCategories.map(
          (subCat: any) => (
